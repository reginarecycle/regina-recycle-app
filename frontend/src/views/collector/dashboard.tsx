  ...
  return (
    <div className="border-t px-4 py-4 md:grid md:grid-cols-[140px_300px_150px_270px_1fr] md:items-center md:gap-2 md:px-6">
      <div className="mb-2 md:mb-0">
        <p className="text-[12px] text-[#9CA3AF] md:text-[14px] md:text-black">
          {item.date}
        </p>
      </div>
      ...
      <div className="mb-4 flex flex-wrap gap-2 md:mb-0 md:flex-nowrap md:whitespace-nowrap">
        {item.details.map((detail, index) => (
          <span
            key={index}
            className="flex h-[30px] min-w-[85px] items-center justify-center rounded-full bg-[#618171] px-3 py-1 text-[13px] text-white md:w-[85px] md:text-[14px]"
          >
            {detail}
          </span>
        ))}
    ...
    <div className="min-h-screen bg-gray-100 p-6 md:p-6">
      ...
      <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="flex min-h-[141px] w-full flex-col items-start gap-[12px] rounded-[8px] border border-[#E5E7EB] bg-white px-[12px] py-[16px]">
          ...
          {/* Bottom row */}
          <div className="flex items-center gap-[4px]">
            <img src={checkIcon} alt="check" className="h-[16px] w-[16px]" />
        ...
        <div className="flex min-h-[141px] w-full flex-col items-start gap-[12px] rounded-[8px] border border-[#E5E7EB] bg-white px-[12px] py-[16px]">
          ...
          {/* Bottom row */}
          <div className="flex items-center gap-[4px]">
            <img src={graphIcon} alt="graph" className="h-[16px] w-[16px]" />
        ...
        <div className="flex min-h-[141px] w-full flex-col items-start gap-[12px] rounded-[8px] border border-[#E5E7EB] bg-white px-[12px] py-[16px]">
          ...
          <div className="flex w-full items-start justify-between">
            ...
            <img src={cashIcon} alt="cash" className="h-[24px] w-[24px]" />
          </div>
          ...
          <div className="flex flex-1 flex-col w-full rounded-[16px] border border-[#E5E7EB] bg-white">
            ...
            <div className="flex items-center justify-between border-b border-[#E5E7EB] px-4 py-4 md:h-[58px] md:px-[24px] md:py-[12px]">
              <div>
                ...
                <p className="text-[12px] text-[#999CA0]">
                  Pickups you need to complete
                </p>
              </div>
