...
function Hero() {
  ...
  return (
    <section className="w-full bg-gradient-to-r from-green-100 to-white py-16 overflow-x-hidden">
      <div className="w-full max-w-7xl mx-auto px-6 md:px-16">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
          <div className="max-w-xl text-center lg:text-left">
            ...
            <h1 className="mt-6 text-4xl sm:text-6xl font-black sm:leading-[72px] leading-tight text-black">
            ...
            <p className="mt-6 text-[#10131D] text-base font-normal leading-6 max-w-[612px] mx-auto lg:mx-0">
