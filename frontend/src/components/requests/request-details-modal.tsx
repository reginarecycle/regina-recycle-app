...
export function RequestDetailsModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <div className="relative w-full max-w-[600px] max-h-[90vh] overflow-y-auto rounded-2xl bg-[#F8F8F8] shadow-2xl">
                {/* Header */}
                <div className="relative border-b border-gray-200 bg-white px-6 pt-6 pb-5">
                    ...
                    <h2 className="text-[20px] font-bold text-[#111827]">Request Details</h2>
                ...
                {/* Summary section */}
                <div
                    className={`px-4 py-6 md:px-5 ${isIncompatible ? "bg-[#DC2626]" : "bg-[#344E41]"
                        }`}
                >
                    ...
                    <div className="mb-6 text-[48px] leading-none font-bold text-white">
                        ${earnings.toFixed(2)}
                    </div>
                ...
                <div className="space-y-6 px-4 py-5 md:px-5">
                    {/* Order Summary */}
                    <div>
                        <h3 className="mb-3 text-[14px] font-medium uppercase tracking-wide text-[#6B7280]">
                            Order Summary
                        </h3>

                        <Card className="overflow-hidden rounded-2xl border border-[#D1D5DB] bg-white shadow-sm">
                    ...
                    <div className="rounded-2xl border border-dashed border-[#D1D5DB] bg-white px-5 py-4">
                        ...
                        <div className="border-t border-[#E5E7EB] pt-3 text-[16px] leading-7 text-[#4B5563]">
                ...
                {/* Footer */}
                <div className="border-t border-[#E5E7EB] bg-[#F8F8F8] px-5 py-5">
                    <div className="flex gap-4">
                        ...
                        <Button
                            onClick={onAccept}
                            className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-[#344E41] py-4 text-white hover:bg-[#2B4035]"
                        >
