...
const tips = [
  ...
  { title: "Composting",           content: "Composting food scraps reduces landfill waste and creates nutrient-rich soil."                   },
  ...
  { title: "Energy Savings",       content: "Recycling one aluminum can saves enough energy to power a TV for three hours."                  },
